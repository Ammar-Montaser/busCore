...
public class Main {
    public static void main(String[] args){
        ...
        while(inn != -1){
                                ...
                                if (innn == 1) {
                                    ...
                                    do  {
                                        ...
                                        if (seat <= 20&&seat>0) {
                                            ...
                                            if (innn < counter || innn == counter) {
                                                int ride=innn-1;
                                                System.out.println("Bus is Booked");
                                                tickets[inn]=new Ticket(Passenger.index,seat,buses[ride].getId());
                                    ...
                                    for(int i=0;i<tickets.length;i++){
                                        if(tickets[i]!=null){
                                            System.out.println(counter + ") " +tickets[++i]);
                                            counter++;
                                            System.out.println("Chose the ride you want to cancel");
                                    ...
                                    System.out.println("There are no more rides to cancel");


                                }
                                else if(innn==3){
                                    for(int i=0;i<Passenger.rides.length;i++){
                                        if(Passenger.rides[i]!=null ){
                                            int c=1;
                                            System.out.println(c + ") " +Passenger.rides[i] + tickets[i] );
                                            c++;
            ...
            if(Admin.loggedadmin&&User.logged){
